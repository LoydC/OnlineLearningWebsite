...
<body class="gray-bg">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form role="form" class="form-inline" action="${ctx}/filemanagement/fileManagement/upload" enctype="multipart/form-data" method="post">
                            <div class="form-group">
                                    <label for="exampleInputEmail2" class="sr-only">Email address</label>
                                    <input type="file" placeholder="Enter email" id="exampleInputEmail2"
                                           class="form-control" name="file" accept="aplication/zip">
                                </div>
		...
		<%-- <form action="${ctx}/filemanagement/fileManagement/upload"
