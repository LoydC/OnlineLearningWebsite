			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						...
						<div class="center">
							<h1>
								<br /> <img src="${ctxStatic }/common/login/images/logo.png"
						...
						<div class="position-relative">
							<div id="login-box"
								class="login-box visible widget-box no-border bound">
											...
											<fieldset>
												<label class="block clearfix"> <span
													...
													class="block input-icon input-icon-right"> <input
														...
														value="admin" class="form-control required"
												...
												<div class="clearfix">
													<label class="inline"> <input type="checkbox"
														...
														${rememberMe ? 'checked' : ''} class="ace" /> <span
														class="lbl"> 记住我</span>
													</label>
										...
										<div class="form-options clearfix">
											<div>
												<a href="#" data-target="#forgot-box" class="pull-left">
													<font color=" #007aff;"><i
														class="ace-icon fa fa-arrow-left"></i> 忘记密码</font>
												</a>
											</div>

											<div>
												<a href="#" data-target="#signup-box"
													class="pull-right user-signup-link"> <font
													color=" #A73438">没有账号？注册 <i
														class="ace-icon fa fa-arrow-right"></i></font>
												</a>
											</div>
										</div>
									</div>
							...
							<div id="forgot-box"
								class="forgot-box widget-box no-border bound">
								<div class="widget-body bound">
									<div class="widget-main bound">
										...
										<div class="form-options center">
											<br /> <br /> <a href="#" data-target="#login-box" class="">
												<font color=" #A73438"><i
													class="ace-icon fa fa-arrow-left"></i> 返回登录 </font>
											</a>
										</div>
									</div>
									<!-- /.widget-main -->
							...
							<div id="signup-box"
								class="signup-box widget-box no-border bound">
								<div class="widget-body bound">
									<div class="widget-main bound">
										...
										<form:form id="inputForm" modelAttribute="user"
											...
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														id="tel" name="mobile" type="text" value="" maxlength="11"
														minlength="11"
														class="form-control text-muted required isMobile"
													...
													class="block input-icon input-icon-right"> <input
														id="code" name="randomCode" type="text" value=""
														maxlength="4" minlength="4" class="required"
														placeholder="验证码" />
												...
												</label> <label class="block"> <input name="ck1"
													type="checkbox" class="required ace" /> <span class="lbl">
														我接受 <a href="#">《JeePlus用户注册协议》</a>
						...
						<!-- /.position-relative -->
						<div class="center">
							<h4 id="id-company-text">
								<font color="#A90E0E">&copy; 西北农林科技大学</font>
							</h4>
						</div>
